...
- 또 다른 유사사례는 이스라엘 기업 에브리사이트(Everysight)의 스마트 글래스 ‘랩터(Raptor)’. 이스라엘은 국가 차원에서 **‘듀얼 유스(Dual-Use, 민군 겸용 기술)’** 전략을 핵심 사업으로 추진함. 이를 통해 ‘방산 R&D → 민간 스타트업 → 글로벌 수출’로 이어지는 혁신 생태계를 구축하. ‘랩터’는 원래 **군용 AR(증강현실) 기술**을 기반으로 개발 이후 민간용 스포츠 AR 글래스로 상용화된 대표적 성공 사례.
...
- 자전거 사고 사망 원인의 60% 이상은 두부 손상. 반면 국내 헬멧 착용률 12.3% ➜ 자전거 이용인구가 증가 추세이므로 안전사고예방을 위한 실질적인 대책이 필수 
